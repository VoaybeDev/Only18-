          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-4">
              <AppLogo
                ...
                logoClassName="h-20 w-20 rounded-[1.5rem] p-2.5"
            ...
            <p className="max-w-2xl text-base leading-7 text-muted-foreground">
              Les médias payants sont floutés jusqu’au paiement simulé. Les
              comptes internes ont accès direct, le subscriber doit
              déverrouiller.
            </p>

            <div className="flex flex-wrap gap-3 text-sm">
              <div className="rounded-full border border-white/10 bg-white/5 px-4 py-2">
                React Router protégé
              </div>
              <div className="rounded-full border border-white/10 bg-white/5 px-4 py-2">
                Persistance locale
              </div>
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Images et vidéo simulées avec URLs publiques.
          </p>
        </div>
